...
|Version         : v.1.2                                              |
|Created         : 01-Jan-2019                                        |
|Last update     : 02-Mars-2019                                       |
|Partie          : 404 PAGE by Saleh Riaz                             | 
        ...
        <div class="stars">
            <div class="custom-navbar">
                <div class="brand-logo">
                   <a href="/ORBITTECHSHOP/index.php?page=home"><img src="/ORBITTECHSHOP/img/OTS-White.png" width="150px"></a>
                </div>
                <div class="navbar-links">
                    <ul>
                      <li><a href="/ORBITTECHSHOP/index.php?page=home">Accueil</a></li>
                      <li><a href="/ORBITTECHSHOP/index.php?page=contact" class="btn-request">Nous Contacter</a></li>
                    </ul>
                </div>
            </div>
